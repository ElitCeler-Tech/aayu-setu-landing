  ...
  return (
    <section className="py-12 md:py-24 bg-white">
      <div className="max-w-6xl mx-auto px-6 text-center">
        <BlurFade delay={0}>
          <h2 className="text-3xl md:text-5xl font-heading font-semibold bg-[linear-gradient(90.52deg,#2D645D_4.83%,#5BCABC_98.02%)] bg-clip-text text-transparent mb-4">
            FOR PATIENTS
          </h2>
        </BlurFade>

        <BlurFade delay={0.2}>
          <p className="text-gray-800 text-base md:text-xl mb-8 md:mb-12">
        ...
        <BlurFade delay={0.6}>
          <p className="text-gray-700 text-base md:text-xl leading-relaxed max-w-5xl mx-auto">
